...
public class TimeSeriesCollectionTest {
    ...
    public void testFindDomainBounds() {
        ...
        r = DatasetUtilities.findDomainBounds(dataset, visibleSeriesKeys, true);
        assertEquals(1199163600000.0, r.getLowerBound(), EPSILON);
        assertEquals(1230785999999.0, r.getUpperBound(), EPSILON);
        ...
        r = DatasetUtilities.findDomainBounds(dataset, visibleSeriesKeys, true);
        assertEquals(1199163600000.0, r.getLowerBound(), EPSILON);
        assertEquals(1293857999999.0, r.getUpperBound(), EPSILON);
